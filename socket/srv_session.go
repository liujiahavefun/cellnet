...
func newSession(stream *ltvStream, eq cellnet.EventQueue, peer cellnet.Peer) *tcpServerSession {
...
func (self *tcpServerSession) FromPeer() cellnet.Peer {
...
func (self *tcpServerSession) RawSend(pkt *cellnet.Packet) {
	if pkt != nil {
...
//接收线程
func (self *tcpServerSession) recvThread(eq cellnet.EventQueue) {
	var err error
